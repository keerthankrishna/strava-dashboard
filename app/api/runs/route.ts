...
// Step A: use your refresh_token to get a short-lived access_token
...
// Step B: fetch up to 200 activities from Strava
...
// Step C: map Strava's shape → your Run interface
...
export async function GET() {
  try {
    ...
    // Strava returns all activity types — filter to runs only
